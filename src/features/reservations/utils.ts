...
export function getStatusIdByName(statuses: IBookingStatus[], statusName: BookingStatusName) {
...
export function buildReservationStatusPayload(booking: IRoomBooking, statusId: string): ICreateBookingPayload {
  return {
