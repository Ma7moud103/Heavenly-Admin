...
export function CreateRoomFormFields({ errors, form, roomStatuses, roomTypes, onChange }: IProps) {
  return (
    <div className="grid gap-4 p-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <label className="grid gap-1.5 text-sm">
          ...
          <select value={form.room_type_id} onChange={(e) => onChange('room_type_id', e.target.value)} className="input">
        ...
        <label className="grid gap-1.5 text-sm">
          ...
          <select value={form.status_id} onChange={(e) => onChange('status_id', e.target.value)} className="input">
      ...
      />
      <SharedInput label="Floor" type="number" value={form.floor} onChange={(e) => onChange('floor', Number(e.target.value))} placeholder="001" />
