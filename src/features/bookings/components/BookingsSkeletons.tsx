...
export function BookingsStatsGridSkeleton() {
  return (
...
export function BookingsTableSectionSkeleton() {
  return (
    <section className="card">
      ...
      <div className="hidden min-h-[22rem] overflow-x-auto md:block">
        <div className="grid grid-cols-[1fr_2fr_1fr_1fr_1fr_56px] gap-4 border-b border-[--color-border] px-4 py-3">
        ...
        <div className="space-y-0 px-4">
          {Array.from({ length: 6 }).map((_, index) => (
            <div
              key={index}
              className="grid grid-cols-[1fr_2fr_1fr_1fr_1fr_56px] items-center gap-4 border-b border-[--color-border-subtle] py-4"
            >
