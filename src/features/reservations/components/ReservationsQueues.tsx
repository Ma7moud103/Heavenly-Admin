    ...
    () => [
      ...
      },
      {
        ...
        cell: (row) => {
          ...
          const arrivalLabel = delta === 0 ? 'Today' : delta === 1 ? 'Tomorrow' : `In ${delta} days`;
...
export function ReservationsQueues({ pendingReservations, confirmedReservations, today, isUpdating, onConfirm, onCancel }: ReservationsQueuesProps) {
